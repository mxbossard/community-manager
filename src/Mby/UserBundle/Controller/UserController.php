...
use Mby\UserBundle\Form\UserType;
use Mby\UserBundle\Form\UserFilterType;
...
class UserController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('MbyUserBundle:User')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("MbyUserBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MbyUserBundle:User')->find($id);
     ...
     * @Method("PUT")
     * @Template("MbyUserBundle:User:edit.html.twig")
     */
